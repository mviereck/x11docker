...
# GUI for x11docker
To use `x11docker-gui`, you need package `kaptain`. If your distribution misses it, see [mviereck/kaptain](https://github.com/mviereck/kaptain). If `kaptain` is not found on your system, x11docker tries to use image [`x11docker/kaptain`](https://hub.docker.com/r/x11docker/kaptain/). 
